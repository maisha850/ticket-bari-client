...
const Advertise = () => {
  ...
  return (
    <section className="py-16 sm:py-20 lg:py-24 transition-colors">
      {/* Header */}
      <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-16 px-4">
        <h3 className="text-title text-green-600">
          Featured Tickets
        </h3>
        <p className="pt-4 sm:pt-5 text-base sm:text-lg text-gray-600 dark:text-gray-400">
          Choose your route, pick your seat, and travel stress-free with fast
          booking, trusted operators, and real-time updates
        </p>
      </div>
      ...
      <div
        className="
          flex justify-center items-center gap-4 sm:gap-6 lg:gap-8
