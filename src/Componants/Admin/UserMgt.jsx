...
//         instance.patch(`/users/role/${user._id}`, roleInfo)
//         .then((res)=>{
...
//                  text: `${user.displayName} marks as a Admin`,
//                  icon: "success"
//                                }); 
//             }
//         })
...
//                  text: `${user.displayName} marks as a Vendor`,
//                  icon: "success"
//                                }); 
//             }
//         })
...
//   Swal.fire({
//     title: "Are you sure?",
//     text: `${user.displayName} will lose vendor access.`,
//     icon: "warning",
...
//     return (
//        <div>
//             <h3 className='text-3xl font-bold'>Manage Users:{users.length}</h3>
//             <p>{searchText}</p>
